...
production_repository_base_url="https://repository.apache.org/content/groups/public/org/apache/arrow"
...
if [ "${TYPE}" = "local" ]; then
  ...
  ${install_command} \
    ${repository_base_url}/${distribution}/${repository_version}/apache-arrow-release-latest.rpm
fi
